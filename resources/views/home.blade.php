        ...
        <header>
            ...
            <section class="bg-white dark:bg-gray-900 h-screen  bg-contain bg-top bg-no-repeat" style="background-image: url('https://i.ibb.co/nbY0rsv/file-2024-01-05-10-24-22.png');">
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    ...
                    <a href="{{route('shop')}}" class="animation-ping inline-flex items-center justify-center px-5 py-3 mr-3 text-xl font-bold text-center text-white rounded-lg bg-blue-800 hover:bg-blue-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Shop Now

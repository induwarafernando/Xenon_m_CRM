    ...
    <div class="container mx-auto py-10">
        ...
        <div class="mt-6 flex flex-row">
            <div class="w-1/2">
                ...
                <p class="text-4xl font-bold">Total Sales: LKR {{ number_format($totalSales, 2) }}</p>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            new Chart(combinedCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Data',
                        data: [{{ $totalCustomers }}, {{ $totalMerchandizers }}, {{ $totalProducts }}, {{ $totalOrders }}],
                        backgroundColor: [
                            'rgba(54, 162, 235, 0.6)',
                            'rgba(255, 99, 132, 0.6)',
                            'rgba(75, 192, 192, 0.6)',
